    ...
    const ROLES = [
      {
        ...
        permissions: [
          ...
          "api::transaction.custom-transaction.request",
          "api::transaction.custom-transaction.issue",
          "api::transaction.custom-transaction.complete",
          "api::transaction.custom-transaction.void",
          "api::stock-movement.custom-stock-movement.stockIn",
          "api::stock-movement.custom-stock-movement.stockOut",
          "api::stock-movement.custom-stock-movement.adjust",
          "api::stock-movement.stock-movement.find",
          "api::stock-movement.stock-movement.findOne",
